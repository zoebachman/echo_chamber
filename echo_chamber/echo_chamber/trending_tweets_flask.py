...
def get_all_trends():
	...
	if len(random_trend) > 10:
		return render_template("index.html", random_trend_long = random_trend)


	else:
		return render_template("index.html", random_trend_short = random_trend)
